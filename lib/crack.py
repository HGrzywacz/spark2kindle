...
class CrackIndex(prototypes.Index):
    ...
    def __init__(self, url):
        ...
        self.title = 'Cracked'
        self.author = 'Cracked.com'
        [self.dirname, self.dirname_no_slash] = ['cracked/','cracked']

        self.sections = list()
        self.sections.append(['Article',url])
...
class CrackSection(prototypes.Section):
    """ Section class usually shouldn't be messed with after initialization.
    """
    ...
    def get_content(self, page_source):
        regContentStart = re.compile('class=\"PageTitle\"')
        regContentStop = re.compile('id=\"fb-like-article\"')
    ...
    def get_images(self, page_source, index):
        pass
