def make_toc(index, sections):
    """Function containing HTML (xml?) code necessary for creating table of content
    file toc.html.
...
def make_opf(index, sections):
    """Function containing XML code necessary for creating opf file.
...
def make_ncx(index, sections):
    """Function containing XML code necessary ncx file.
